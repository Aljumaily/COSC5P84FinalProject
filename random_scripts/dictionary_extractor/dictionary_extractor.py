# To run the French extractor:
#   First, download 'kaikki.org-dictionary-French.jsonl' from
#   https://kaikki.org/dictionary/French/
#   and rename it to 'french_dictionary.jsonl' and place it in /french:
#   Run this command:
#   /bin/python3 /home/maysara/Desktop/tri-language-version/random_scripts/dictionary_extractor/dictionary_extractor.py --json_file_path=random_scripts/dictionary_extractor/french/french_dictionary.jsonl --saving_path=random_scripts/dictionary_extractor/french/output
# To run the Spanish extractor:
#   First, download 'kaikki.org-dictionary-Spanish.jsonl' from
#   https://kaikki.org/dictionary/Spanish/
#   and rename it to 'spanish_dictionary.jsonl' and place it in /spanish:
#   Run this command:
#   /bin/python3 /home/maysara/Desktop/tri-language-version/random_scripts/dictionary_extractor/dictionary_extractor.py --json_file_path=random_scripts/dictionary_extractor/spanish/spanish_dictionary.jsonl --saving_path=random_scripts/dictionary_extractor/spanish/output
